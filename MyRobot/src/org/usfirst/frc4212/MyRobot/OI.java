...
public class OI {
    ...
    public OI() {
        ...
        joystick_Retract = new JoystickButton(joystick_1, 1);
        joystick_Retract.whileHeld(new Retract_Command());
        joystick_Extend = new JoystickButton(joystick_1, 1);
        joystick_Extend.whileHeld(new Extend_Command());
        joystick_Lower = new JoystickButton(joystick_1, 1);
        joystick_Lower.whileHeld(new Lower_Command());
        joystick_Lift = new JoystickButton(joystick_1, 1);
        joystick_Lift.whileHeld(new Lift_Command());
        joystick_Eject = new JoystickButton(joystick_1, 1);
