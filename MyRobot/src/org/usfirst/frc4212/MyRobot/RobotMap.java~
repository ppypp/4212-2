...
public class RobotMap {
    ...
    public static SpeedController elevatorElevator_1;
    public static SpeedController elevatorElevator_2;
    public static SpeedController armArm_1;
    public static SpeedController armArm_2;
    public static SpeedController pickupPickup_1;
    public static PowerDistributionPanel sensorsPowerDistributionPanel_1;
    ...
    public static void init() {
        ...
        elevatorElevator_1 = new VictorSP(4);
        LiveWindow.addActuator("Elevator", "Elevator_1", (VictorSP) elevatorElevator_1);
        
        elevatorElevator_2 = new VictorSP(5);
        LiveWindow.addActuator("Elevator", "Elevator_2", (VictorSP) elevatorElevator_2);
        
        armArm_1 = new VictorSP(6);
        LiveWindow.addActuator("Arm", "Arm_1", (VictorSP) armArm_1);
        
        armArm_2 = new VictorSP(7);
        LiveWindow.addActuator("Arm", "Arm_2", (VictorSP) armArm_2);
        
        pickupPickup_1 = new Talon(8);
        LiveWindow.addActuator("Pickup", "Pickup_1", (Talon) pickupPickup_1);
        
        sensorsPowerDistributionPanel_1 = new PowerDistributionPanel(0);
        LiveWindow.addSensor("Sensors", "PowerDistributionPanel_1", sensorsPowerDistributionPanel_1);
